 ...
 */
public class relocaterobot extends Command {
    ...
    protected void execute() {
    	...
    	Robot.movedarobot.drivezRobot(-Robot.oi.getJoystick1().getTwist(), Robot.oi.getJoystick1().getY(), Robot.oi.getJoystick1().getX());
