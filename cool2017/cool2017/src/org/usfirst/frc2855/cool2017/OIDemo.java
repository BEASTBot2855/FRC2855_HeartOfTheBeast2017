...
public class OIDemo extends OI {
    ...
    public OIDemo() {
         ...
         *  
         * This OI is to be used in demo mode. Switch which OI is used in Robot.java to change mode.
         */
        ...
        createmark = new JoystickButton(joystick2, 1);
        ...
        fly = new JoystickButton(joystick2, 9);
