 ...
 */
public class RobotDrive2855 implements MotorSafety {
  ...
  public enum MotorType {
    kFrontLeft(0), kFrontRight(1), kRearLeft(2), kRearRight(3), kRearLeft2(4), kRearRight2(5);
  ...
  protected SpeedController m_rearLeftMotor2;
  protected SpeedController m_rearRightMotor2;
   ...
   */
  public RobotDrive2855(final int leftMotorChannel, final int rightMotorChannel) {
   ...
   */
  public RobotDrive2855(final int frontLeftMotor, final int rearLeftMotor, final int frontRightMotor,
                    final int rearRightMotor, final int rearLeftMotor2, final int rearRightMotor2) {
    m_sensitivity = kDefaultSensitivity;
    m_maxOutput = kDefaultMaxOutput;
    m_rearLeftMotor = new Talon(rearLeftMotor);
    m_rearLeftMotor2 = new Talon(rearLeftMotor2);
    m_rearRightMotor = new Talon(rearRightMotor);
    m_rearRightMotor2 = new Talon(rearRightMotor2);
   ...
   */
  public RobotDrive2855(SpeedController leftMotor, SpeedController rightMotor) {
   ...
   */
  public RobotDrive2855(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
                    SpeedController frontRightMotor, SpeedController rearRightMotor, 
                    SpeedController rearLeftMotor2, SpeedController rearRightMotor2) {
    ...
    m_rearLeftMotor2 = requireNonNull(rearLeftMotor2, "rearLeftMotor2 cannot be null");
    ...
    m_rearRightMotor2 = requireNonNull(rearRightMotor2, "rearRightMotor2 cannot be null");
    m_sensitivity = kDefaultSensitivity;
    m_maxOutput = kDefaultMaxOutput;
    m_allocatedSpeedControllers = false;
    setupMotorSafety();
   ...
   *                      Y_AXIS)
   * @param rotateStick   The Joystick object that represents the strafe value
   * @param rotateAxis    The axis on the strafe object to use for the rotate right/left
   *                      (typically X_AXIS)
   * @param squaredInputs Setting this parameter to true decreases the sensitivity at lower speeds
   */
   ...
   * @param strafe  The rate of strafe for the robot that is completely independent of the
   *                  translation. [-1.0..1.0]
   ...
   *                  are independent of the strafe rate.
   * @param strafe  The rate of strafe for the robot that is completely independent of the
   *                  magnitute or direction. [-1.0..1.0]
   */
  public void mecanumDrive_Polar(double magnitude, double direction, double strafe) {
    ...
    double[] wheelSpeeds = new double[kMaxNumberOfMotors];
    wheelSpeeds[MotorType.kFrontLeft.value] = (sinD * magnitude + strafe);
    wheelSpeeds[MotorType.kFrontRight.value] = (cosD * magnitude - strafe);
    wheelSpeeds[MotorType.kRearLeft.value] = (cosD * magnitude + strafe);
    wheelSpeeds[MotorType.kRearRight.value] = (sinD * magnitude - strafe);
   ...
   *                  independent of the strafe rate.
   * @param strafe  The rate of strafe for the robot that is completely independent of the
   *                  magnitute or direction. [-1.0..1.0]
   */
  void holonomicDrive(double magnitude, double direction, double strafe) {
    mecanumDrive_Polar(magnitude, direction, strafe);
  }
   ...
   *
   * @param kfrontright      The motor index to invert.
   * @param isInverted True if the motor should be inverted when operated.
   */
  public void setInvertedMotor(RobotDrive2855.MotorType kfrontright, boolean isInverted) {
    switch (kfrontright) {
      case kFrontLeft:
      ...
      case kRearRight:
        ...
        break;
      default:
        throw new IllegalArgumentException("Illegal motor type: " + kfrontright);
    }
  }
