...
public class OI {
    ...
    public JoystickButton gearDown;
    public JoystickButton gearUp;
    ...
    public OI() {
        ...
        gearUp = new JoystickButton(joystick2, 5);
        gearUp.whileHeld(new Gearupndown(true));
        gearDown = new JoystickButton(joystick2, 4);
        gearDown.whileHeld(new Gearupndown(false));
        ...
        //descendButton = new JoystickButton(joystick1, 11);
        //descendButton.whileHeld(new climb());
